...
class Request:
    ...
    def __init__(self):
        ...
        self.__world = get_args().world
        self.__lang = re.sub(r'[^a-zA-Z]', '', get_args().world)
    ...
    def login(self):
        self.__session, self.initial_response = Login(self.__lang, self.__world).login(get_args().username, get_args().password)
